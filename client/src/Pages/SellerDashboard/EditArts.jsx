...
// import { useUpdateProductMutation, useProductByIdQuery } from "../../redux/api/productApiSlice";
...
//   const [orderBy, setOrderBy] = useState(item?.orderBy || "")
...
//       const { productData } = await updateProduct({ productId: id, formData });
