...
const Dashboard = () => {
  ...
  return (
    <div className="mx-5 my-5">
      {currentLoaction === "/createPortfolio" ? <>
        <h1 className="font-bold text-3xl font-roboto-slab">Dashboard</h1>

        <div className="flex gap-5 text-white" >
          <Link to="profile" className="mt-10 bg-red-400 h-[14rem] w-[15rem] rounded-xl flex flex-col items-center p-5">
          ...
          <Link to="artGallery" className="mt-10 bg-blue-400 h-[14rem]  w-[15rem] rounded-xl flex flex-col items-center p-5">
          ...
          <Link to="create" className="mt-10 bg-green-400 h-[14rem] w-[15rem] rounded-xl flex flex-col items-center p-5">
            <div className="flex flex-col items-center mt-12">
