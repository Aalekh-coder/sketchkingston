      ...
      <div className="bg-yellow-300 rounded-2xl border h-[80vh] w-[90vw] mx-auto">
        ...
        <form onSubmit={submitHandler} className="flex flex-col items-center gap-5 mt-5">
          ...
          <div className="flex items-center gap-4">
            <input type="checkbox" id="seller" className="mt-1" value={isSeller} onChange={(e) => setIsSeller(e.target.checked)} />
            <label htmlFor="seller" className="font-semibold sm:text-lg">
              I want to be seller
            </label>
          </div>

          <button className="bg-yellow-400 px-10 py-2 rounded-2xl font-bold md:py-3 md:px-14 md:text-xl" type="submit" disabled={isLoading} >{isLoading ? "Signup.." : "Signup"}</button>
          {isLoading && <Loader />}
        </form>
